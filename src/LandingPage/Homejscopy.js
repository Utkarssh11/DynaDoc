                    ...
                    <div className="row h-100">
                      ...
                      <div className="col-sm-9 text-center text-sm-start pt-3 pt-sm-0">
                        ...
                        <p>
                          ...
                          proved. I believe that theDYNAdoc staff is doing an
                    ...
                    <div className="row h-100">
                      ...
                      <div className="col-sm-9 text-center text-sm-start pt-3 pt-sm-0">
                        ...
                        <p>
                          ...
                          prescriptions, medications, and other services they
                          offer are 100% genuine, medically verified, and
                          proved. I believe that the DYNAdoc staff is doing an
                          outstanding job. Highly recommended their health care
                          services.
                        </p>
                      </div>
              ...
              <div className="col-lg-6 z-index-2">
                <form className="row g-3">
                  <div className="col-md-6">
                    ...
                    <input
                      className="form-control form-DYNAdoc-control"
                      id="inputName"
                      type="text"
                      placeholder="Name"
                    />
            ...
            <div className="row">
              <div className="col-lg-6">
                ...
                <p className="text-soft-primary">
                  DYNAdoc was created in order to improve the patient
                  experience. <br />
                ...
                <form className="row gx-2 gy-2 align-items-center">
                  <div className="col">
                    <div className="input-group-icon">
                      ...
                      <input
                        className="form-control form-DYNAdoc-control form-cta-control text-soft-primary"
                        id="inputEmailCta"
                        type="email"
                        placeholder="Email"
                      />
